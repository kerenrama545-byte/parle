<x-layouts.main>
            ...
            <div class="ak-commmon-heading">
                <div class="ak-section-heading ak-style-1 ak-type-1 ak-color-1 page-top-title">
                    <div class="ak-section-subtitle">
                        <a href="{{ route('home') }}">Home</a> / Our Menu
                    </div>
                    <h2 class="ak-section-title page-title-anim">Our Menu</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="set-bg-img-section">
        <img src="template/restaurant/assets/img/menuBg.png" alt="..." data-speed="1.1" class="imagesZoom bg-img ak-bg">
        ...
        <div class="container">
            ...
            <div class="ak-menu-list">
                <div class="ak-menu-list-section-1">
                    <img src="template/restaurant/assets/img/item-show_2.png" alt="...">
    ...
    <section class="set-bg-img-section">
        <img src="template/restaurant/assets/img/bessertsMenuBg.png" alt="..." data-speed="1.1" class="bg-img ak-bg imagesZoom">
        <div class="ak-height-150 ak-height-lg-60"></div>
        <div class="container">
            <div class="ak-section-heading ak-style-1 ak-type-1">
                <div class="ak-section-subtitle">
            ...
            <div class="ak-menu-list">
                <div class="ak-menu-list-section-1">
                    <img src="template/restaurant/assets/img/item-show.png" alt="...">
                    <div class="food-menu style-1">
                        <div class="food-menu-section-1">
                            <div class="food-menu-title">
                                <p>Spaghetti alla Carbonara</p>
    ...
    <section class="set-bg-img-section">
        <img src="template/restaurant/assets/img/barMenuBg.png" alt="..." data-speed="1.1" class="bg-img ak-bg imagesZoom">
        <div class="ak-height-150 ak-height-lg-60"></div>
        <div class="container">
            <div class="ak-section-heading ak-style-1 ak-type-1">
                <div class="ak-section-subtitle">
            ...
            <div class="ak-menu-list">
                <div class="ak-menu-list-section-1">
                    <img src="template/restaurant/assets/img/item-show_3.png" alt="...">
                    <div class="food-menu style-1">
                        <div class="food-menu-section-1">
                            <div class="food-menu-title">
                                <p>Spaghetti alla Carbonara</p>
