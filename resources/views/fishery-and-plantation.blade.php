<x-layouts.main>
    ...
    <section>
        <div class="ak-hero ak-style1 heignt-100vh">
            <div class="ak-hero-bg ak-bg" data-src="{{ asset('images/fishery-and-plantation.png') }}"></div>
            <div class="container">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-info">
                                    <div class="hero-title">
                                        <p class="mini-title">Parle Group</p>
                                        <h1 class="hero-main-title">Fishery & Plantation</h1>
                                        <h1 class="hero-main-title-1 style-2">Coming Soon</h1>
                                    </div>
