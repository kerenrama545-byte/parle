            ...
            <div class="border border-zinc-200 bg-zinc-50 p-6 rounded-lg shadow">
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <flux:field>
                        ...
                        <flux:input type="text" wire:model="whatsapp" placeholder="Enter WhatsApp number or link" />
                        <flux:error name="whatsapp" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Instagram</flux:label>
                        <flux:input type="text" wire:model="instagram" placeholder="Enter Instagram link" />
                        <flux:error name="instagram" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Facebook</flux:label>
                        <flux:input type="text" wire:model="facebook" placeholder="Enter Facebook link" />
                        <flux:error name="facebook" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Twitter</flux:label>
                        <flux:input type="text" wire:model="twitter" placeholder="Enter Twitter link" />
                        <flux:error name="twitter" />
                    </flux:field>

                    <flux:field>
                        <flux:label>LinkedIn</flux:label>
                        <flux:input type="text" wire:model="linkedin" placeholder="Enter LinkedIn link" />
